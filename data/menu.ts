...
export const menu: Dish[] = [
  ...
  { id: "chicken-bowl", name: "Chicken Bowl", description: "Pollo, pomodorini, insalata, maio spicy, teriyaki, patata e cipolla fritta.", ingredients: ["pollo", "pomodorini", "insalata", "maio spicy", "teriyaki", "patata fritta", "cipolla fritta"], price: 400, category: "antipasti", image: "/menu/chicken-bowl.png", imageAlt: "Chicken bowl con pollo e verdure", allergens: ["glutine", "uova", "soia"], spicyLevel: 1 },
  ...
  // === BEVANDE ===
  {
    id: "acqua-naturale",
    name: "Acqua Naturale",
    description: "Bottiglia 50cl naturale.",
    ingredients: ["acqua naturale 50cl"],
    price: 200,
    category: "bevande",
    image: "/menu/acqua-naturale.png",
    imageAlt: "Acqua naturale 50cl",
    allergens: [],
    spicyLevel: 0,
    bgFrom: "#60a5fa",
    bgTo: "#1e3a8a",
  },
  {
    ...
    description: "Bottiglia 50cl frizzante.",
    ingredients: ["acqua frizzante 50cl"],
    price: 200,
    category: "bevande",
    image: "/menu/acqua-frizzante.png",
    imageAlt: "Acqua frizzante 50cl",
    allergens: [],
    spicyLevel: 0,
    bgFrom: "#22d3ee",
    bgTo: "#155e75",
  ...
  },
  {
    id: "coca-cola-zero",
    name: "Coca-Cola Zero",
    description: "Lattina 33cl ghiacciata, senza zucchero.",
    ingredients: ["lattina 33cl"],
    price: 200,
    category: "bevande",
    image: "/menu/coca-cola-zero.png",
    imageAlt: "Coca-Cola Zero lattina 33cl",
    allergens: [],
    spicyLevel: 0,
    bgFrom: "#1a1a1a",
    bgTo: "#000000",
